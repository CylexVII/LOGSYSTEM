WeaponNames = {
			   [tostring(GetHashKey('WEAPON_UNARMED'))] = 'Yumruk',
			   [tostring(GetHashKey('WEAPON_KNIFE'))] = 'Bıçak',
			   [tostring(GetHashKey('WEAPON_NIGHTSTICK'))] = 'Jop',
			   [tostring(GetHashKey('WEAPON_HAMMER'))] = 'Çekiç',
			   [tostring(GetHashKey('WEAPON_BAT'))] = 'Beyzbol Sopası',
			   [tostring(GetHashKey('WEAPON_GOLFCLUB'))] = 'Golf Sopası',
			   [tostring(GetHashKey('WEAPON_CROWBAR'))] = 'Levye',
			   [tostring(GetHashKey('WEAPON_PISTOL'))] = 'Tabanca',
			   ...
			   [tostring(GetHashKey('WEAPON_GRENADE'))] = 'El Bombası',
			   ...
			   [tostring(GetHashKey('WEAPON_HATCHET'))] = 'Balta',
			   [tostring(GetHashKey('WEAPON_COMBATPDW'))] = 'Combat PDW',
			   [tostring(GetHashKey('WEAPON_KNUCKLE'))] = 'Muşta',
			   [tostring(GetHashKey('WEAPON_MARKSMANPISTOL'))] = 'Marksman Pistol',
			   [tostring(GetHashKey('WEAPON_MACHETE'))] = 'Pala',
			   ...
			   [tostring(GetHashKey('WEAPON_FIRE'))] = 'Ateş',
